...
const Kanban = () => {
  ...
  // const [titleData, setTitleData] = useState(mockData.tasks.content);
  ...
  //   setTitleData((prevList) => [...prevList, inputData]);
  // };
      ...
      <div className="kanban_wrapper">
        <AlwaysScrollSection>
          <div className="kanban_buttonWrapper">
            <button onClick={changePart1} className="index_total1">
              전체 공간
            </button>
            <button onClick={changePart2} className="index_total2">
              PM
            </button>
            <button onClick={changePart3} className="index_total3">
              개발자
            </button>
            <button onClick={changePart4} className="index_total4">
              디자이너
            </button>
          </div>
          <div className="codeConventionWrapper">
            <div className="codeConvention">
              ...
              <div className="kanban_save_button_wrapper">
                <button className="kanban_save_button" onClick={codeSubmit}>
                  저장하기
                </button>
              </div>
            </div>
          ...
          <div className="freespaceWrapper">
            <div className="freespace">
              ...
              ></div> */}
              <div className="kanban_save_button_wrapper">
                <button onClick={freeSubmit} className="kanban_save_button">
                  저장하기
                </button>
              </div>
            </div>
                    ...
                    {(provided) => (
                      ...
                      >
                        ...
                        <div className="kanban_insert_wrapper">
                          {/* <form
                            className="kanban_insert_wrapper"
                          ...
                          >
                            ...
                            <button
                              type="submit"
                              className="kanban_insert_button"
                            >
                              +
                            </button>
                          </form> */}
